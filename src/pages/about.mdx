...
This is a list of the technologies I have used in the past and I am currently 
using. I am not an expert in all of them, but I have used them enough to be able 
to work with them.
...
There are technologies that don't technically fit the category 
they are in, but I have put them there because that is their closest match.
